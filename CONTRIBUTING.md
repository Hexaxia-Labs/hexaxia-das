...
The full test suite should pass (180 tests).
...
hexaxia-das/
  das/
    ...
    naming.py     - declared naming conventions: pattern compile + filename render
...
- Hexaxia DAS version (`das --version` reports the package version; equivalently the version
  from `pyproject.toml`, currently `0.4.0`, or the git SHA)
